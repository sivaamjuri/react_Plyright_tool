                                    ...
                                    <div className="visual-grid">
                                        <div className="view-container">
                                            ...
                                            <div className="image-wrapper">
                                                <img src={`${import.meta.env.VITE_API_URL || 'https://amendment-accustom-unhidden.ngrok-free.dev'}${info.solutionImage}`} alt="Solution" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="view-container student">
                                            ...
                                            <div className="image-wrapper">
                                                <img src={`${import.meta.env.VITE_API_URL || 'https://amendment-accustom-unhidden.ngrok-free.dev'}${info.studentImage}`} alt="Student" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="view-container diff">
                                            ...
                                            <div className="image-wrapper">
                                                <img src={`${import.meta.env.VITE_API_URL || 'https://amendment-accustom-unhidden.ngrok-free.dev'}${info.diffImage}`} alt="Difference" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
